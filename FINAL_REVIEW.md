...
Actualización posterior de seguridad: el repositorio incorpora SSO WordPress RS256, sesión HS256 en cookie HttpOnly, 20 minutos de inactividad con varias pestañas y preparación manual de Apache/Gunicorn/systemd. **188 pruebas pasan (82 anteriores + 106 nuevas)**; no se cambió lógica de inventario ni se escribió en Google o desplegó infraestructura. Documentación de esta fase: [AUTENTICACION_SSO.md](docs/AUTENTICACION_SSO.md), [DEPLOY_GCP_APACHE.md](docs/DEPLOY_GCP_APACHE.md) y [VALIDATION.md](VALIDATION.md). Lo que sigue conserva el análisis funcional y la evidencia histórica previa.
